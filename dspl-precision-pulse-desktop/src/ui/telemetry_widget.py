...
class TelemetryWidget(QWidget):
    ...
    def update_all_parameters(self):
        ...
        for param_id, param in parameters.items():
            if param_id in self.parameter_widgets:
                ...
                widget['timestamp_label'].setText(format_time_utc(datetime.now()))
    ...
    def on_connection_status_changed(self, is_connected):
        ...
        if is_connected:
            print("[UI] MQTT connected - resuming chart updates")
            self.is_paused = False
        else:
            print("[UI] MQTT disconnected - pausing chart updates")
            self.is_paused = True
